      ...
      >
        <swiper-slide v-for="(subjectCard, index) in subjectsCards" :key="index"> 
          ...
          <router-link class="h-full w-full flex flex-col items-center" :to="subjectCard.destination">
            <div class="z-20">
              <img class="h-24 shad" 
              :src="getImageUrl(subjectCard.imageURL)" alt="pic"
            >
            </div>

            <div class="flex flex-col justify-center px-3 h-[100vh] w-full -mt-10 bg-slate-50 rounded-3xl shadow-xl  text-gray-700 ">
