          ...
          <div class="mx-auto max-w-7xl px-6 lg:px-8">
            <div class="relative z-10">
              ...
              <p class="mx-auto mt-4 max-w-2xl text-center text-lg leading-8 text-white/60">
                ...
                quos odit doloribus molestiae voluptatum quos odit doloribus.
              </p>
  ...
  sections: [
    {
      ...
      features: [
        ...
        {
          name: 'Multi-accounts',
          tiers: { Starter: '3 accounts', Scale: 'Unlimited accounts', Growth: '7 accounts' }
        },
        {
          name: 'Invoicing',
          tiers: { Starter: '3 invoices', Scale: 'Unlimited invoices', Growth: '10 invoices' }
        },
