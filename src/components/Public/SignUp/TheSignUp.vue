<template>
  <div
    class="flex min-h-full flex-1 flex-col justify-center py-12 lg:py-28 sm:px-6 lg:px-8 bg-gray-50"
  >
...
import SignUpForm from '@/Components/Public/SignUp/SignUpForm.vue'
</script>
